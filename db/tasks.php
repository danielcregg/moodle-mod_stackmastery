...
$tasks = [
    [
        ...
        'classname' => 'mod_stackmastery\task\cleanup_task',
        'blocking' => 0,
        'minute' => 'R',
        'hour' => '3',
        'day' => '*',
    ...
    [
        // Weekly (Sunday): pseudonymised experience export for offline policy retraining.
        // Inert unless the experienceexport setting is enabled.
        'classname' => 'mod_stackmastery\task\export_experience_task',
        'blocking' => 0,
        'minute' => 'R',
        'hour' => 'R',
        'day' => '*',
